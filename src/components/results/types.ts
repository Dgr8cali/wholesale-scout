...
export interface Result {
  ...
  /** Last written: for a finished row, when it was screened. */
  ...
  product: {
    ...
    competitor_stock?: { at: string; sellers: { sellerId: string; name: string | null; fba: boolean; stock: number | null; limited: boolean; source?: string | null; at?: string | null }[] } | null;
