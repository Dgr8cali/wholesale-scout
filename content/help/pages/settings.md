...
| 8 | [Demand](/help/gates/demand) (fail) | **Min sales / month (total)** 30, **Min your share (sales / month)** 5, **Max 90-day average rank** 50,000 (only for products with no sales figure; any category not in **Max rank by category**, which starts with the suggested table: Beauty and Health & Personal Care 60,000, Grocery 50,000, Automotive, DIY & Tools and Sports & Outdoors 150,000, Home & Kitchen 200,000; **Reset to suggested** restores it), **Max months to sell the order** 3 |
